...
#   3. '연평균 손익' 높은 것(손절치는 것 감안한다.)
#       2020/03 손절은 무시(코로나로 대부분 종목 손절)
#   고평가 경우 매수 금지라서 거래 적고 손절 없는 것 보단, 거래 많고 손절 적은게 낫다
#   1차 매수량 40%, 2차 매수량 60%
...
BUYABLE_COUNT = 10                          # 상위 몇개 종목까지 매수 가능 종목으로 유지
